...
- Statistical model: the covariance matrix is now tracked by its lower cholesky factor

### Added

- Fisher Information Matrix estimation: sampling the conditional distribution now allows to estimate the FIM, with stochastic approximation over accumulated samples
